...
(async () => {
  ...
  <table>
    <thead><tr><th>Ticker</th><th>Setup</th><th>Price</th><th>Upside</th><th>Rev Gr</th><th>Dynamic R:R</th><th>Entry</th><th>Stop (2x ATR)</th><th>Analyst Target</th><th>Noise Signals</th></tr></thead>
    <tbody>
`;
