...
function compositeScore(m = {}) {
  ...
  // ---- weights
  let weights = { fundamentals: 0.25, quality: 0.20, valuation: 0.20, technical: 0.15, catalysts: 0.10, insider: 0.10 };
  // We don't auto-score "catalysts" (qualitative); fold its weight into fundamentals.
  weights.fundamentals += weights.catalysts; delete weights.catalysts;
  if (!hasInsider) {
